...
import { getDocFromWord, writeWordFileRepository } from '@repositories/word/wordISFile.repositories'
...
export interface DiarioTarefaInterna {
  processo?: string;
  origem?: string;
  descricao?: string;
  prazo?: string;
...
export interface DiarioRegistroDocx {
