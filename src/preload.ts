...
contextBridge.exposeInMainWorld('API', {
    ...
    validateIntimationRegister: async (data: iFileData, credentials: credential): Promise<string> => await ipcRenderer.invoke('validate-intimation-register', data, credentials),
    validateAnaliseRegister: async (data: iFileData, credentials: credential): Promise<string> => await ipcRenderer.invoke('validate-analise-register', data, credentials),
